...
// @namespace          https://github.com/tjz404/search-engine-switcher
// @supportURL         https://github.com/tjz404/search-engine-switcher/issues
// @updateURL          https://github.com/tjz404/search-engine-switcher/raw/main/Switcher.user.js
// @downloadURL        https://github.com/tjz404/search-engine-switcher/raw/main/Switcher.user.js
// @match              *://www.baidu.com/*
      ...
      void (async function (getConfigureData, getResultFilterData, requestRemoteIcon, GMnotification) {
        ...
        void (async function (getUpdateAddress) {
          ...
          def.var.gradientButtonStyle =
            `#${def.const.leftButton} input,#${def.const.rightButton} input,input.${def.const.scrollbars},input.${def.const.scrollbarsV2}{outline:none!important;border:none!important;background:linear-gradient(to right,#77A1D3 0%,#79CBCA 51%,#77A1D3 100%) left center/200% auto!important;background-image:linear-gradient(to right,#77A1D3 0%,#79CBCA 51%,#77A1D3 100%)!important;background-size:200% auto!important;background-position:left center!important;color:#fff!important;box-shadow:0 0 20px #eee!important;text-align:center!important;text-decoration:none!important;text-transform:none!important;text-shadow:none!important;transition:background-position .5s ease,color .2s ease,box-shadow .2s ease!important}` +
            `#${def.const.leftButton} input:hover,#${def.const.rightButton} input:hover,input.${def.const.scrollbars}:hover,input.${def.const.scrollbarsV2}:hover{background:linear-gradient(to right,#77A1D3 0%,#79CBCA 51%,#77A1D3 100%) right center/200% auto!important;background-image:linear-gradient(to right,#77A1D3 0%,#79CBCA 51%,#77A1D3 100%)!important;background-size:200% auto!important;background-position:right center!important;color:#fff!important;text-decoration:none!important;box-shadow:0 0 20px #eee!important;transform:none!important}`;
          ...
          void (async function (getUpdateInformation, parseUpdateInformatio) {
            ...
            const siteConfigMap = {
              ...
              bing: {
                ...
                applyButton: ({ buttonSection, target, shadow }) => {
                  ...
                  addBingJumpButtons();
                  sleep(500).then(addBingJumpButtons);
                },
              },
              duckduckgo: {
            ...
            function addBingJumpButtons() {
              if (listCurrentSite.siteTypeID !== newSiteType.BING || qS("#bing-custom-jump-buttons")) return;
        ...
        async () => {
          ...
          const defaults = { isAutoUpdate: false, keywordHighlight: false, isHotkey: true, selectedEngine: [2, 19, 20], localWindow: true };
